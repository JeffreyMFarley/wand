...
A function or method exceeding **400 lines** qualifies the file automatically, 
regardless of how deeply the call is nested in conditionals or loops. Do not require
the call to be at the top level of the function. Count lines excluding blank lines 
and comments
